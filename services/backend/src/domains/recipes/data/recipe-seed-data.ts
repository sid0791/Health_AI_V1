...
export const RECIPE_SEED_DATA: CreateRecipeDto[] = [
  ...
  createRecipeDto({
    ...
    description:
      'A nutritious twist on traditional pulao using quinoa instead of rice, packed with colorful vegetables and aromatic spices.',
    cuisine: 'Indian',
    ...
    ingredients: [
      { ingredientName: 'quinoa', quantity: 200, unit: 'g', sortOrder: 1 },
      {
        ...
        quantity: 300,
        unit: 'g',
        preparationNote: 'diced (carrots, peas, beans)',
        sortOrder: 2,
      },
      {
    ...
    steps: [
      {
        stepNumber: 1,
        instruction: 'Rinse quinoa thoroughly under cold water until water runs clear.',
        durationMinutes: 2,
      },
      {
        stepNumber: 2,
        instruction: 'Heat olive oil in a heavy-bottomed pan over medium heat.',
        durationMinutes: 1,
        cookingMethod: 'saute',
      },
      ...
      {
        stepNumber: 4,
        instruction: 'Add chopped onions and sauté until golden brown.',
        durationMinutes: 3,
        cookingMethod: 'saute',
      },
      {
        stepNumber: 5,
        instruction: 'Add ginger-garlic paste and cook for 1 minute until fragrant.',
        durationMinutes: 1,
      },
      {
        stepNumber: 6,
        instruction: 'Add mixed vegetables and cook for 5 minutes, stirring occasionally.',
        durationMinutes: 5,
        cookingMethod: 'saute',
      },
      {
        stepNumber: 7,
        instruction: 'Add turmeric, garam masala, and salt. Mix well.',
        durationMinutes: 1,
      },
      {
        stepNumber: 8,
        instruction: 'Add quinoa and stir gently to coat with spices.',
        durationMinutes: 1,
      },
      {
        stepNumber: 9,
      ...
      {
        stepNumber: 10,
        instruction: 'Reduce heat to low, cover and simmer for 15 minutes until quinoa is cooked.',
        durationMinutes: 15,
        cookingMethod: 'simmer',
      },
      {
        stepNumber: 11,
        instruction: 'Let it rest for 5 minutes, then fluff with a fork.',
        durationMinutes: 5,
      },
      {
        stepNumber: 12,
        instruction: 'Garnish with fresh coriander and serve hot.',
        durationMinutes: 1,
      },
    ],
    dataSource: 'internal',
  ...
  createRecipeDto({
    ...
    description:
      'Protein-rich savory pancakes made from yellow lentils, loaded with fresh vegetables. Perfect for a healthy breakfast or snack.',
    cuisine: 'Indian',
    ...
    ingredients: [
      {
        ingredientName: 'yellow moong dal',
        quantity: 200,
        unit: 'g',
        preparationNote: 'soaked for 3 hours',
        sortOrder: 1,
      },
      {
        ingredientName: 'onion',
    ...
    steps: [
      {
        stepNumber: 1,
        instruction: 'Drain and grind soaked moong dal to a smooth paste with minimal water.',
        durationMinutes: 5,
      },
      {
        stepNumber: 2,
        instruction: 'Transfer to a bowl and add all vegetables and spices.',
        durationMinutes: 2,
      },
      {
        stepNumber: 3,
        instruction: 'Mix well to form a thick batter. Add water if needed.',
        durationMinutes: 2,
      },
      {
        stepNumber: 4,
        instruction: 'Heat a non-stick pan over medium heat and brush with oil.',
        durationMinutes: 1,
        cookingMethod: 'fry',
      },
      {
        stepNumber: 5,
        instruction: 'Pour a ladleful of batter and spread into a thin circle.',
        durationMinutes: 1,
      },
      {
        stepNumber: 6,
        instruction: 'Cook for 2-3 minutes until bottom is golden.',
        durationMinutes: 3,
        cookingMethod: 'fry',
      },
      {
        stepNumber: 7,
        instruction: 'Flip and cook the other side for 2 minutes.',
        durationMinutes: 2,
        cookingMethod: 'fry',
      },
  ...
  createRecipeDto({
    ...
    description:
      'A refreshing and protein-packed salad bowl with chickpeas, fresh vegetables, and a zesty lemon-herb dressing.',
    ...
    ingredients: [
      {
        ...
        quantity: 400,
        unit: 'g',
        preparationNote: 'cooked and drained',
        sortOrder: 1,
      },
      {
      ...
      },
      {
        ...
        quantity: 50,
        unit: 'g',
        preparationNote: 'pitted and sliced',
        sortOrder: 6,
      },
      {
    ...
    steps: [
      ...
      {
        stepNumber: 2,
        instruction: 'Add olives and feta cheese if using.',
        durationMinutes: 1,
        cookingMethod: 'mix',
      },
      {
      ...
      {
        stepNumber: 4,
        instruction: 'Pour dressing over the salad and toss well to combine.',
        durationMinutes: 2,
        cookingMethod: 'mix',
      },
      {
        stepNumber: 5,
        instruction: 'Let sit for 10 minutes to allow flavors to meld.',
        durationMinutes: 10,
      },
      {
        stepNumber: 6,
        instruction: 'Garnish with fresh parsley and serve chilled.',
        durationMinutes: 1,
      },
    ],
    dataSource: 'internal',
  ...
  createRecipeDto({
    ...
    description:
      'Light and flavorful zucchini noodles with a creamy peanut sauce, packed with vegetables and plant-based protein.',
    cuisine: 'Thai',
    dietType: [DietType.VEGETARIAN, DietType.VEGAN],
    mealType: [MealType.LUNCH, MealType.DINNER],
    difficultyLevel: DifficultyLevel.MEDIUM,
    ...
    ingredients: [
      {
        ...
        quantity: 3,
        unit: 'large',
        preparationNote: 'spiralized into noodles',
        sortOrder: 1,
      },
      {
      ...
      },
      {
        ...
        quantity: 150,
        unit: 'g',
        preparationNote: 'shelled and cooked',
        sortOrder: 4,
      },
      {
        ...
        quantity: 3,
        unit: 'tbsp',
        preparationNote: 'natural, unsweetened',
        sortOrder: 5,
      },
    ...
    steps: [
      {
        stepNumber: 1,
        instruction: 'Prepare zucchini noodles using a spiralizer or vegetable peeler.',
        durationMinutes: 5,
      },
      {
        stepNumber: 2,
        instruction:
          'In a large bowl, combine zucchini noodles, carrots, bell pepper, and edamame.',
        durationMinutes: 2,
        cookingMethod: 'mix',
      },
      {
        stepNumber: 3,
        instruction:
          'In a small bowl, whisk together peanut butter, lime juice, soy sauce, sesame oil, garlic, ginger, and chili flakes.',
        durationMinutes: 3,
        cookingMethod: 'mix',
      },
      {
        stepNumber: 4,
        instruction: 'Add water gradually to achieve desired consistency for the sauce.',
        durationMinutes: 1,
        cookingMethod: 'mix',
      },
      {
        stepNumber: 5,
        instruction: 'Pour sauce over the vegetable noodle mixture and toss well.',
        durationMinutes: 2,
        cookingMethod: 'mix',
      },
      {
        stepNumber: 6,
        instruction: 'Let sit for 5 minutes to allow flavors to meld.',
        durationMinutes: 5,
      },
      {
        stepNumber: 7,
        instruction: 'Garnish with chopped peanuts and cilantro before serving.',
        durationMinutes: 1,
      },
    ],
    dataSource: 'internal',
  ...
  createRecipeDto({
    ...
    description:
      'A guilt-free pizza alternative with cauliflower crust, topped with fresh tomatoes, basil, and light cheese.',
    cuisine: 'Italian',
    dietType: [DietType.VEGETARIAN],
    ...
    ingredients: [
      ...
      },
      {
        ...
        quantity: 100,
        unit: 'g',
        preparationNote: 'part-skim, shredded',
        sortOrder: 2,
      },
      {
    ...
    steps: [
      {
        stepNumber: 1,
        instruction: 'Preheat oven to 220°C (425°F).',
      ...
      },
      {
        stepNumber: 2,
        instruction:
          'Steam cauliflower rice for 5 minutes, then cool and squeeze out excess moisture.',
        durationMinutes: 8,
        cookingMethod: 'steam',
      },
      {
        stepNumber: 3,
        instruction:
          'Mix cauliflower with 60g mozzarella, parmesan, egg, garlic powder, oregano, and salt.',
        durationMinutes: 3,
        cookingMethod: 'mix',
      },
      {
        stepNumber: 4,
        instruction: 'Press mixture into a thin circle on parchment-lined baking sheet.',
        durationMinutes: 5,
      },
      {
        stepNumber: 5,
        instruction: 'Bake crust for 15 minutes until golden and firm.',
        durationMinutes: 15,
        cookingMethod: 'bake',
        temperatureCelsius: 220,
      },
      ...
      {
        stepNumber: 7,
        instruction: 'Top with remaining mozzarella and cherry tomatoes.',
        durationMinutes: 2,
      },
      {
        stepNumber: 8,
        instruction: 'Bake for another 10 minutes until cheese melts.',
        durationMinutes: 10,
        cookingMethod: 'bake',
        temperatureCelsius: 220,
      },
      {
        stepNumber: 9,
        instruction: 'Garnish with fresh basil and drizzle with olive oil.',
        durationMinutes: 1,
      },
      {
        stepNumber: 10,
        instruction: 'Let cool for 3 minutes before slicing and serving.',
        durationMinutes: 3,
      },
    ],
    dataSource: 'internal',
  ...
  createRecipeDto({
    ...
    description:
      'A nutrient-dense bowl designed to support hormonal balance with anti-inflammatory ingredients, healthy fats, and fiber-rich vegetables.',
    ...
    steps: [
      ...
      {
        stepNumber: 2,
        instruction: 'Toss sweet potato cubes with half the olive oil and roast for 20 minutes.',
        durationMinutes: 20,
        cookingMethod: 'roast',
        temperatureCelsius: 200,
      },
      {
        stepNumber: 3,
        instruction: 'Steam broccoli for 5 minutes until tender-crisp.',
        durationMinutes: 5,
        cookingMethod: 'steam',
      },
      {
        stepNumber: 4,
        instruction:
          'Mix tahini, lemon juice, turmeric, remaining olive oil, and salt for dressing.',
        durationMinutes: 2,
        cookingMethod: 'mix',
      },
      ...
      {
        stepNumber: 6,
        instruction: 'Top with quinoa, roasted sweet potato, steamed broccoli, and chickpeas.',
        durationMinutes: 3,
      },
      {
        stepNumber: 7,
        instruction: 'Add avocado slices and sprinkle with pumpkin seeds.',
        durationMinutes: 2,
      },
      {
        stepNumber: 8,
        instruction: 'Drizzle with tahini dressing and serve immediately.',
        durationMinutes: 1,
      },
    ],
    dataSource: 'internal',
...
export function getRecipesByCategory(category: string): CreateRecipeDto[] {
  switch (category) {
    case RECIPE_CATEGORIES.INDIAN_VEGETARIAN:
      return RECIPE_SEED_DATA.filter(
        (recipe) => recipe.cuisine === 'Indian' && recipe.dietType.includes(DietType.VEGETARIAN),
      );
